      ...
      {messages?.length === 0 ? (
        ...
        <>
          <div className="flex-1 overflow-auto">
            <div className="text-center py-3 dark:bg-black dark:text-white dark:text-neutral-300 text-neutral-500 text-sm border border-b-neutral-300 dark:border-none">AI: {OpenAIModelNames[model]}</div>
